...
Popup {
    ...
    property color surfaceFillColor: root.dark ? Qt.rgba(0.12, 0.13, 0.16, 0.96) : Qt.rgba(1, 1, 1, 0.98)
    ...
    implicitHeight: Math.min(
        root.maxPopupHeight > 0 ? root.maxPopupHeight : 100000,
        (root.contentItem ? root.contentItem.implicitHeight : 0) + root.topPadding + root.bottomPadding
    )
